"""
Test if we really need the local operation: directly pass Transformer block
...
def develop10A(num_classes=40, **kwargs: Any) -> Develop10:
    return Develop10(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def develop10Amax(num_classes=40, **kwargs: Any) -> Develop10:
    return Develop10(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop10A ...")
    pointsformer = develop10A()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing develop10Amax ...")
    pointsformer = develop10Amax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
