"""
More complex down block, attentional fusion.
"""
...
def develop3Amax(num_classes=40, **kwargs: Any) -> Develop3:
    return Develop3(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop3Amax ...")
    pointsformer = develop3Amax()
