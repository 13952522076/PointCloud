...
def developA(num_classes=40, **kwargs: Any) -> Develop:
    return Develop(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def developAmax(num_classes=40, **kwargs: Any) -> Develop:
    return Develop(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing developA ...")
    pointsformer = developA()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing developAmax ...")
    pointsformer = developAmax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
