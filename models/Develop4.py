"""
Exactly similar to simpler2, but dropout in classify layer
"""
...
def develop4Amax(num_classes=40, **kwargs: Any) -> Develop4:
    return Develop4(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)

if __name__ == '__main__':

    print("===> testing Simpler2Amax ...")
    pointsformer = develop4Amax()
