"""
Test if we really need the local operation: only FFN in Transformer block
a develop template, copyed from simple2.py
"""
...
def develop11A(num_classes=40, **kwargs: Any) -> Develop11:
    return Develop11(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def develop11Amax(num_classes=40, **kwargs: Any) -> Develop11:
    return Develop11(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop11A ...")
    pointsformer = develop11A()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing develop11Amax ...")
    pointsformer = develop11Amax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
