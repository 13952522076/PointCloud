...
def develop6Amax(num_classes=40, **kwargs: Any) -> Develop6:
    return Develop6(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)

def develop6A(num_classes=40, **kwargs: Any) -> Develop6:
    return Develop6(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing Develop6A ...")
    pointsformer = develop6A()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing Develop6Amax ...")
    pointsformer = develop6Amax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
