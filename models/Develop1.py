"""
Simply mean Down block features with more mapping layers.
"""
...
def develop1Amax(num_classes=40, **kwargs: Any) -> Develop1:
    return Develop1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop1Amax ...")
    pointsformer = develop1Amax()
