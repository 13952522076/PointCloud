...
def develop8A(num_classes=40, **kwargs: Any) -> Develop8:
    return Develop8(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def develop8Amax(num_classes=40, **kwargs: Any) -> Develop8:
    return Develop8(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop8A ...")
    pointsformer = develop8A()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing develop8Amax ...")
    pointsformer = develop8Amax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
