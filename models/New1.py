...
def new1A(num_classes=40, **kwargs: Any) -> New1:
    return New1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def new1Amax(num_classes=40, **kwargs: Any) -> New1:
    return New1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)

def new1Bmax(num_classes=40, **kwargs: Any) -> New1:
    return New1(num_classes=num_classes, blocks=[2, 2, 2, 2], reducer=4, pool="max", **kwargs)

def new1Cmax(num_classes=40, **kwargs: Any) -> New1:
    return New1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max",
