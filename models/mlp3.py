"""
Similiar to PointNet, just MLP without BN, without dropout.
"""
...
def MLP3_max(num_classes=40, **kwargs) -> MLP3:
    return MLP3(num_classes=num_classes, pool="max", **kwargs)

def MLP3_avg(num_classes=40, **kwargs) -> MLP3:
    return MLP3(num_classes=num_classes, pool="avg", **kwargs)


if __name__ == '__main__':
    print("===> testing pointNet with use_normals")
    data = torch.rand(10, 6, 1024)
    model = MLP3_avg(k=40, use_normals=True)
    out = model(data)
