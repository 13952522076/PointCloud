...
def new2A(num_classes=40, **kwargs: Any) -> New2:
    return New2(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def new2Amax(num_classes=40, **kwargs: Any) -> New2:
    return New2(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)

def new2Bmax(num_classes=40, **kwargs: Any) -> New2:
    return New2(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, embed_channel=64, pool="max", **kwargs)

def new2Cmax(num_classes=40, **kwargs: Any) -> New2:
    return New2(num_classes=num_classes, blocks=[1, 1, 1, 1],
