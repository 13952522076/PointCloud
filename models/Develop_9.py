"""
a Develop9 template, copyed from simple2.py
...
def develop9A(num_classes=40, **kwargs: Any) -> Develop9:
    return Develop9(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def develop9Amax(num_classes=40, **kwargs: Any) -> Develop9:
    return Develop9(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop9A ...")
    pointsformer = develop9A()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing develop9Amax ...")
    pointsformer = develop9Amax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
