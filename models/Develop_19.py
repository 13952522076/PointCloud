...
def develop19A(num_classes=40, **kwargs: Any) -> Develop19:
    return Develop19(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop19A ...")
    pointsformer = develop19A()
