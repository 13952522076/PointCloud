"""
Add a global attention
a develop12 template, copyed from simple2.py
"""
...
def develop12A(num_classes=40, **kwargs: Any) -> Develop12:
    return Develop12(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def develop12Amax(num_classes=40, **kwargs: Any) -> Develop12:
    return Develop12(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)
...
if __name__ == '__main__':
    ...
    print("===> testing develop12A ...")
    pointsformer = develop12A()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)

    print("===> testing develop12Amax ...")
    pointsformer = develop12Amax()
    data = torch.rand(2, 6, 1024)
    out = pointsformer(data)
    print(out["logits"].shape)
